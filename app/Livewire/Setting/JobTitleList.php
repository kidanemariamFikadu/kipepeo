...
class JobTitleList extends Component
{
    ...
    #[On('job-title-changed')]
    public function jobTitleChanged()
    {
    }
    ...
    public function removeJobTitle($jobTitleId)
    {
    ...
    {
        return view('livewire.setting.job-title-list')->title('Job Titles');
    }
}
