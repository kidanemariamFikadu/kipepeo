    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-4 md:p-5">
            ...
            <ul class="mt-3 divide-y divide-gray-200 dark:divide-gray-600">
                @forelse ($this->results as $student)
                    @php
                    ...
                    <li wire:key="{{ $student->id }}" class="flex items-center justify-between gap-3 py-2.5">
                        ...
                        @if ($isIn)
                            <button type="button" wire:loading.attr="disabled" wire:target="checkOut({{ $student->id }})"
                        ...
                        @else
                            <button type="button" wire:loading.attr="disabled" wire:target="checkIn({{ $student->id }})"
                ...
                @empty
                    <li class="py-4 text-sm text-gray-500 dark:text-gray-400">No students found.</li>
                @endforelse
            </ul>
