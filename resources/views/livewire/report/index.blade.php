<div>
    <div class="mb-4 border-b border-gray-200 dark:border-gray-700 no-print">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab"
            ...
            data-tabs-active-classes="text-primary-700 hover:text-primary-700 dark:text-primary-500 dark:hover:text-primary-500 border-primary-700 dark:border-primary-500"
            ...
            <li class="me-2" role="presentation">
                <button
                    ...
                    id="grade-distribution-styled-tab" data-tabs-target="#styled-grade-distribution" type="button"
                    role="tab" aria-controls="grade-distribution" aria-selected="false">
                    <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="me-2" role="presentation">
                <button
                    class="inline-flex items-center justify-center p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                    id="book-rental-styled-tab" data-tabs-target="#styled-book-rental" type="button" role="tab"
                    aria-controls="book-rental" aria-selected="false">
                    <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="me-2" role="presentation">
                <button
                    class="inline-flex items-center justify-center p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                    id="volunteer-styled-tab" data-tabs-target="#styled-volunteer" type="button" role="tab"
                    aria-controls="volunteer" aria-selected="false">
                    <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
    ...
    <div id="default-styled-tab-content">
        ...
        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-grade-distribution" role="tabpanel"
            aria-labelledby="grade-distribution-tab">
            <livewire:report.grade-distribution-report />
        </div>
        ...
        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-volunteer" role="tabpanel"
            aria-labelledby="volunteer-tab">
            <livewire:report.volunteer-report />
        </div>
    </div>
