<div>
    ...
    <div class="p-2 md:p-6">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-2xl font-semibold text-gray-700 dark:text-white">Import Students</h2>
    ...
    <form class="p-4 md:p-5" wire:submit="importStudents">
        <div class="grid gap-4 mb-4 grid-cols-1">
            <div class="col-span-1 sm:col-span-1">
                ...
                <input
                    ...
                    aria-describedby="file_input_help" id="file_input" wire:model="students" type="file">
        ...
        <button type="submit" wire:loading.attr="disabled" wire:target="importStudents"
            ...
            <svg class="h-5 w-5 text-white mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                ...
                wire:loading.remove wire:target="importStudents">
                <path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z" />
                <polyline points="17 21 17 13 7 13 7 21" />
                <polyline points="7 3 7 8 15 8" />
            </svg>
            <x-spinner class="h-5 w-5 text-white mr-2" wire:loading wire:target="importStudents" />
            <span wire:loading.remove wire:target="importStudents">Submit</span>
            <span wire:loading wire:target="importStudents">Uploading…</span>
        </button>
    </form>
    </div>
    </div>
